...
#getOrganisms()
#pathways <- getMultiOmicsFeatures(dbs = "kegg" , layer = "transcriptome",returnTranscriptome = "ENTREZID",useLocal = FALSE,organism = 'hsapiens')
...
{
  dir.create(gsub(list_results[i],pattern='DGE.xls',replacement='KEGG_multigsea'))
  ...
  WriteXLS(enrichment_scores,gsub(list_results[i],pattern='DGE',replacement='KEGG_multigsea/KEGG_GSEA'))
