...
###Export results
write.xlsx(result,'../results/02_classification_effect/merged_phases/cell_groups_lesion_vs_eutopic_AD.xlsx')
...
###Export results
write.xlsx(result,'../results/02_classification_effect/merged_phases/cell_groups_lesion_vs_eutopic_Transition.xlsx')
