...
write.xlsx(result,'../results/02_classification_effect/merged_phases/cell_subgroups_eutopic_AD_versus_control.xlsx')
...
write.xlsx(result,'../results/02_classification_effect/merged_phases/cell_subgroups_eutopic_T_versus_control.xlsx')
...
write.xlsx(result,'../results/02_classification_effect/merged_phases/cell_subgroups_eutopic_AD_versus_T.xlsx')
