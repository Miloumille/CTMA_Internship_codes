...
###Export results
write.xlsx(result,'../results/02_classification_effect/merged_phases/cell_subgroups_myometrium_compared_AD_vs_control.xlsx')
...
###Export results
write.xlsx(result,'../results/02_classification_effect/merged_phases/cell_subgroups_myometrium_compared_T_vs_control.xlsx')
...
###Export results
write.xlsx(result,'../results/02_classification_effect/merged_phases/cell_subgroups_myometrium_compared_AD_vs_transition.xlsx')
